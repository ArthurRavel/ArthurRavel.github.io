...
function initializeTypingAnimation() {
    ...
    const texts = [
        ...
        'Développeur Python & R',
        'Créateur de solutions data-driven'
    ];
...
function addInteractiveEffects() {
    // Card hover effects
    const cards = document.querySelectorAll('.highlight-item, .skill-category, .timeline-content, .contact-item');
